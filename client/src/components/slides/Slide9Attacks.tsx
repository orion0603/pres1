...
const Slide9Attacks = () => {
  ...
  balances[msg.sender] = 0;
                ...
                <div className="bg-badir-grey/10 rounded-xl p-4 h-80 border border-badir-tan/30">
                  ...
                  <div className="border border-badir-tan/30 rounded-lg h-60 p-3 bg-white relative overflow-hidden">
                    <motion.div 
              ...
              {ceiStep > 0 && (
                <div className="mt-6 bg-badir-mocha/5 rounded-lg p-4 border border-badir-mocha/10">
                  ...
                  <div className="grid grid-cols-3 gap-4">
                    <div className={`rounded-lg p-3 ${ceiStep >= 1 ? 'bg-green-100 border border-green-300' : 'bg-gray-100 border border-gray-300'}`}>
                      ...
                      <pre className="text-xs mt-2 bg-white p-2 rounded">{`// Verify the sender's balance
uint amount = balances[msg.sender];
require(amount > 0, "No balance");`}</pre>
                    </div>
                    
                    <div className={`rounded-lg p-3 ${ceiStep >= 2 ? 'bg-green-100 border border-green-300' : 'bg-gray-100 border border-gray-300'}`}>
                      <h5 className="font-semibold flex items-center">
                        <span className="w-6 h-6 rounded-full bg-green-500 text-white flex items-center justify-center mr-2 text-xs">2</span>
                        Effects
                      </h5>
